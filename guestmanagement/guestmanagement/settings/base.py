"""
Django settings for guestmanagement project.
...
SECRET_KEY = "django-insecure-wjcn5+_x!!mj1u#&h_b3^4(0v!vc*l)!gl50i^50z@i#xq^)$i"
...
DEFAULT_FROM_EMAIL = 'noreply@guestmanagement.local'
